...
import de.articdive.phatloots.PhatLootsConfig;
import de.articdive.phatloots.PhatLootsUtil;
...
public class LootCommand {
	...
	@CommandHandler.CodCommand(command = "give", subcommand = "all", weight = 150.1, minArgs = 1)
	...
	@CommandHandler.CodCommand(command = "give", weight = 151.1, minArgs = 1)
	...
	@CommandHandler.CodCommand(command = "give", weight = 152)
	...
	@CommandHandler.CodCommand(command = "give", weight = 152.1, minArgs = 1)
