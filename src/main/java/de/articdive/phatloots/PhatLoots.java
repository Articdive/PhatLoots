package de.articdive.phatloots;

import com.google.common.io.Files;
import de.articdive.phatloots.commands.CommandHandler;
import de.articdive.phatloots.commands.LootCommand;
import de.articdive.phatloots.commands.ManageLootCommand;
import de.articdive.phatloots.commands.ManageMoneyLootCommand;
import de.articdive.phatloots.commands.ManageMythicDropsLootCommand;
import de.articdive.phatloots.commands.ManageMythicMobsLootCommand;
import de.articdive.phatloots.commands.VariableLootCommand;
import de.articdive.phatloots.events.ChestRespawnEvent;
import de.articdive.phatloots.gui.InventoryListener;
import de.articdive.phatloots.listeners.CitizensListener;
import de.articdive.phatloots.listeners.DispenserListener;
import de.articdive.phatloots.listeners.FishingListener;
import de.articdive.phatloots.listeners.LootBagListener;
import de.articdive.phatloots.listeners.LootingBonusListener;
import de.articdive.phatloots.listeners.MobDeathListener;
import de.articdive.phatloots.listeners.MobListener;
import de.articdive.phatloots.listeners.MobSpawnListener;
import de.articdive.phatloots.listeners.PhatLootsListener;
import de.articdive.phatloots.listeners.VoteListener;
import de.articdive.phatloots.loot.CommandLoot;
import de.articdive.phatloots.loot.Experience;
import de.articdive.phatloots.loot.Gem;
import de.articdive.phatloots.loot.Item;
import de.articdive.phatloots.loot.LootCollection;
import de.articdive.phatloots.loot.Message;
import de.articdive.phatloots.loot.Money;
import de.articdive.phatloots.loot.MythicDropsItem;
import de.articdive.phatloots.loot.MythicMobsItem;
import de.articdive.phatloots.loot.UnidentifiedItem;
import de.articdive.phatloots.regions.RegionHook;
import de.articdive.phatloots.regions.RegionToolsRegionHook;
...
public class PhatLoots extends JavaPlugin {
	...
	public void onDisable() {
		...
		for (PhatLootChest chest : (Collection<PhatLootChest>) PhatLootChest.chestsToRespawn.clone()) {
			chest.respawn(ChestRespawnEvent.RespawnReason.PLUGIN_DISABLED);
		}
	}
